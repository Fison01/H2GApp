        ...
        myDatabaseRef.orderByChild("email").equalTo(user.getEmail())
                .addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                        editor.putString(getString(R.string.pref_login_user_email), dataSnapshot.child("email").getValue().toString());
                        editor.putString(getString(R.string.pref_login_user_role), dataSnapshot.child("role").getValue().toString());
                        editor.commit();
                    }
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        // [START_EXCLUDE]
                        if (!task.isSuccessful()) {
                            mStatusTextView.setText("Auth fail");
                        }
                       // hideProgressDialog();
                        // [END_EXCLUDE]
                    }
